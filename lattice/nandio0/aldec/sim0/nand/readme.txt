...
defining the operating voltage.
    ...
    ---------   ------------
    ModelSim    vlog -sv +define+V33 nand_die_model.v
    NC-Verilog  ncverilog -sv +v2k +define+V33 nand_die_model.v
    VCS         vcs -sverilog +v2k +define+V33 nand_die_model.v
...
model.  The following are examples of defining the width.
    ...
    simulator   command line
    ---------   ------------
    ModelSim    vlog -sv +define+x8 nand_die_model.v
    NC-Verilog  ncverilog -sv +v2k +define+x8 nand_die_model.v
    VCS         vcs -sverilog +v2k +define+x8 nand_die_model.v
...
The following are examples of defining the classification.
    ...
    simulator   command line
    ---------   ------------
    ModelSim    vlog -sv +define+CLASSD nand_die_model.v
    NC-Verilog  ncverilog -sv +v2k +define+CLASSD nand_die_model.v
    VCS         vcs -sverilog +v2k +define+CLASSD nand_die_model.v
...
model has a define called "SHORT_RESET"
    simulator   command line
    ---------   ------------
    ModelSim    vlog -sv +define+SHORT_RESET nand_die_model.v
    NC-Verilog  ncverilog -sv +v2k +define+SHORT_RESET nand_die_model.v
    VCS         vcs -sverilog +v2k +define+SHORT_RESET nand_die_model.v
...
The user will need to switch from async mode to sync mode as normally explained in the spec.  
    simulator   command line
    ---------   ------------
    ModelSim    vlog -sv +define+NAND_SYNC nand_die_model.v
    NC-Verilog  ncverilog -sv +v2k +define+NAND_SYNC nand_die_model.v
    VCS         vcs -sverilog +v2k +define+NAND_SYNC nand_die_model.v
