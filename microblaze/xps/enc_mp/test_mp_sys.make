...
# C:\Users\konrad.eisele\git\hw\microblaze\xps\enc_mp\test_mp_sys.mhs

include test_mp_sys_incl.make
...
sim: $(DEFAULT_SIM_SCRIPT)
	...
	test_mp_sys_fuse.cmd
	cd simulation/behavioral & \
	start /B $(SIM_CMD) -gui -tclbatch test_mp_sys_setup.tcl
...
$(MICROBLAZE_1_BOOTLOOP): $(MICROBLAZE_BOOTLOOP_LE)
	IF NOT EXIST "$(BOOTLOOP_DIR)" @mkdir "$(BOOTLOOP_DIR)"
	cp -f $(MICROBLAZE_BOOTLOOP_LE) $(MICROBLAZE_1_BOOTLOOP)
